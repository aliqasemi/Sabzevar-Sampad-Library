                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            ...
                            <a class="btn btn-black bg-info text-white" style="margin-top: 20px ;" href="/lending_update/{{$lending->id}}" data-toggle="modal" data-target="#deleteModal">حذف</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a type="button" class="btn btn-primary" href="/book_delete/{{$lending->id}}" >بله حذف کن</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
